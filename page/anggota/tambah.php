...
if ($simpan) {
    ...
    if ($sql) {
        ...
        $id_memmber1  = $koneksi->insert_id;

?>

        <script type="text/javascript">
            alert("Data Berhasil Disimpan harap lakukan pembayaraan pertama");
            window.location.href = "?page=transaksi&aksi=bayar&id=<?php echo $id_memmber1; ?>";
        </script>
<?php
    }
}
